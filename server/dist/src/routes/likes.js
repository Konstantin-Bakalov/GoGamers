...
likesRouter.post('/', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reviewId = zod_1.z.number().parse(req.body.reviewId);
    const user = (0, auth_middleware_1.currentUser)(res);
    const like = yield likes_service_1.likesService.create(user.id, reviewId);
    res.status(200).json(likeTransformer.transform(like));
})));
likesRouter.delete('/:reviewId', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reviewId = (0, zod_validator_1.zodStringAsNumber)().parse(req.params.reviewId);
    const user = (0, auth_middleware_1.currentUser)(res);
    yield likes_service_1.likesService.delete(user.id, reviewId);
    res.status(200).json({});
})));
