...
gamesRouter.get('/:id', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const game = yield game_service_1.default.findGameById(Number(id));
    res.status(200).json(transformer.transform(game));
})));
gamesRouter.get('/', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { results, total } = yield game_service_1.default.listGames({
        page: page - 1,
        pageSize: maxItems,
        searchText,
        orderBy,
...
gamesRouter.post('/', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const game = yield game_service_1.default.create(parsedGame);
    res.status(200).json(transformer.transform(game));
})));
gamesRouter.delete('/:id', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = (0, zod_validator_1.zodStringAsNumber)().parse(req.params.id);
    const user = (0, auth_middleware_1.currentUser)(res);
    yield game_service_1.default.deleteById(id, user.id);
    res.status(200).json({ message: 'Game deleted' });
})));
gamesRouter.put('/', auth_middleware_1.default, (0, request_handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = (0, auth_middleware_1.currentUser)(res);
    ...
    const updatedGame = yield game_service_1.default.update(game, user.id);
